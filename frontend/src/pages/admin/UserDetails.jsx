...
function UserDetails({ userId, onClose, fetchUsers }) {
  ...
  const PromoteUserRole = async (email, newRole) => {
    try {
      ...
      toast.error(err.message || "Failed to promote user role");
    }
  };
  ...
  const demoteUserRole = async (adminId, reason) => {
    try {
      const res = await adminApi.demoteAdmin(adminId, reason);
      console.log("res of user demoting=>", res);
      if (res.success) {
        toast.success("User role demoted successfully");
        fetchUserDetails();
        if (fetchUsers) fetchUsers();
      }
    } catch (err) {
      console.log("err in demoting user", err);
    }
  };
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-slate-900/95 via-red-900/90 to-rose-900/95 backdrop-blur-md flex items-center justify-center z-50">
        <div className="bg-white p-10 rounded-3xl shadow-2xl max-w-md w-full mx-4 border border-gray-100 relative overflow-hidden">
          ...
          <div className="text-center">
            ...
            <p className="text-red-600 mb-8 bg-red-50 p-4 rounded-xl border border-red-200">
              {error}
            </p>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center mb-3 gap-3">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto">
              ...
              <div className="bg-white/15 backdrop-blur-md rounded-xl p-2 border border-white/20 shadow-lg">
                <label className="block text-xs font-medium mb-1 text-blue-100">
                  Status
                </label>
                <select
                ...
                >
                  ...
                  <option value="Banned" className="text-gray-800">
                    🔴 Banned
                  </option>
                </select>
              </div>
              ...
              <div className="bg-white/15 backdrop-blur-md rounded-xl p-2 border border-white/20 shadow-lg">
                ...
                <div className="flex gap-1">
                  ...
                  >
                    ...
                    <option value="super-admin" className="text-gray-800">
                      👑 Super Admin
                    </option>
                  </select>
                  <button
          ...
          {showreason && (
            <div className="relative z-10 mb-3">
              <div className="bg-white/15 backdrop-blur-md rounded-xl p-3 border border-white/20 shadow-lg">
                <h4 className="text-sm font-semibold mb-2 text-blue-100">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-center gap-4">
            ...
            <div className="relative group">
              <div className="relative">
                ...
                <div
                  className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full border-2 border-white shadow-lg flex items-center justify-center text-sm font-bold ${
                    userDetails.isAdmin
            ...
            <div className="text-center sm:text-left flex-1">
              ...
              <div className="flex flex-wrap justify-center sm:justify-start gap-1">
                <span
                  className={`px-2 py-1 rounded-lg text-xs font-bold backdrop-blur-md border border-white/30 shadow-sm ${getRoleColor(
                    userDetails.role
                  )}`}
                >
                ...
                <span
                  className={`px-2 py-1 rounded-lg text-xs font-bold backdrop-blur-md border border-white/30 shadow-sm ${
                    userDetails.isAdmin
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
            {[
              ...
              <div key={i} className="group relative">
                {/* Glow Effect */}
                <div
                  className={`absolute -inset-1 bg-gradient-to-r ${stat.gradient} rounded-xl blur-sm opacity-20 group-hover:opacity-40 transition-all duration-500`}
                ></div>
                ...
                <div className="relative bg-white p-4 sm:p-5 rounded-xl border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <div className="text-center">
                    {/* Icon */}
                    <div
                      className={`w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 bg-gradient-to-br ${stat.iconBg} rounded-xl flex items-center justify-center shadow-md transform transition-all duration-300 group-hover:scale-110`}
                    >
                    ...
                    {/* Value */}
                    <div
                      className={`text-2xl sm:text-3xl font-black mb-1 bg-gradient-to-r ${stat.gradient} bg-clip-text text-transparent`}
                    >
                      {stat.value}
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1">
              ...
              <div className="p-4 space-y-4 max-h-80 overflow-y-auto">
                  ...
                  <div className="group">
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-xl border border-blue-100 group-hover:border-blue-300 transition-all duration-300 hover:shadow-md">
                      <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                        <span className="text-sm bg-gradient-to-r from-blue-500 to-indigo-600 p-1 rounded-lg text-white">
                          📝
                        </span>
                ...
                {userDetails.profile?.experience && (
                  <div className="group">
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-3 rounded-xl border border-green-100 group-hover:border-green-300 transition-all duration-300 hover:shadow-md">
                      <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                        <span className="text-sm bg-gradient-to-r from-green-500 to-emerald-600 p-1 rounded-lg text-white">
                          💼
                        </span>
                  ...
                  userDetails.profile.skills.length > 0 && (
                    <div className="group">
                      <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-3 rounded-xl border border-purple-100 group-hover:border-purple-300 transition-all duration-300 hover:shadow-md">
                        <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                          <span className="text-sm bg-gradient-to-r from-purple-500 to-pink-600 p-1 rounded-lg text-white">
                            🛠️
                          </span>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {userDetails.profile.skills
                            ...
                            .map((skill, index) => (
                              <span
                                key={index}
                                className="px-2 py-1 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-xs rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5"
                              >
                                {skill}
                              </span>
                            ))}
                ...
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-3 rounded-xl border border-yellow-100">
                  <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                    <span className="text-sm bg-gradient-to-r from-yellow-500 to-orange-600 p-1 rounded-lg text-white">
                      📊
                    </span>
                    ...
                    {[
                      {
                        ...
                        value: userDetails.profile?.points || 0,
                        gradient: "from-yellow-400 to-orange-500",
                        icon: "🏆",
                      },
                      {
                        label: "Reliability Score",
                        value: `${userDetails.profile?.reliabilityScore || 0}%`,
                        gradient: "from-green-400 to-emerald-500",
                        icon: "⭐",
                      },
                      {
                        label: "Weekly Logins",
                        value: userDetails.profile?.weeklyLogins?.length || 0,
                        gradient: "from-blue-400 to-indigo-500",
                        icon: "📅",
                      },
                      {
                        label: "GitHub Commits",
                        value: userDetails.profile?.githubCommits || 0,
                      ...
                      <div
                        key={index}
                        className={`bg-gradient-to-r ${item.gradient} p-2 rounded-lg text-white text-center shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5`}
                      >
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {userDetails.tasks.slice(0, 3).map((task, index) => (
                        <div
                          key={index}
                          className="bg-gradient-to-r from-gray-50 to-blue-50 p-3 rounded-xl border-l-4 border-blue-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-0.5"
                        >
                          <div className="flex justify-between items-start mb-2">
                            <h5 className="font-semibold text-gray-800 text-xs flex-1 pr-2">
                              {task.title}
                            </h5>
                            <span
                    ...
                    {userDetails.projects?.owned?.length > 0 && (
                      <div className="mb-3">
                        <h5 className="text-xs font-bold text-purple-800 mb-2 flex items-center gap-1">
                          <span className="bg-gradient-to-r from-purple-500 to-pink-600 text-white px-1 py-0.5 rounded text-xs">
                            👑
                          </span>
                          <span>
                            Owned Projects ({userDetails.projects.owned.length})
                          </span>
                        </h5>
                        <div className="space-y-2">
                          {userDetails.projects.owned
                            ...
                            .map((project, index) => (
                              <div
                                key={index}
                                className="bg-gradient-to-r from-purple-50 to-pink-50 p-2 rounded-xl border border-purple-200 hover:border-purple-400 transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5"
                              >
                    ...
                    {userDetails.projects?.joined?.length > 0 && (
                      <div>
                        <h5 className="text-xs font-bold text-green-800 mb-2 flex items-center gap-1">
                          <span className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-1 py-0.5 rounded text-xs">
                            🤝
                          </span>
                          <span>
                        ...
                        <div className="space-y-2">
                          {userDetails.projects.joined
                            ...
                            .map((project, index) => (
                              <div
                                key={index}
                                className="bg-gradient-to-r from-green-50 to-emerald-50 p-2 rounded-xl border border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5"
                              >
                                ...
                                <div className="text-xs text-green-600 flex items-center gap-1">
                                  <span>👥</span>
                                  <span>
                                    Team Size: {project.user?.length || 0}{" "}
                                    members
                                  </span>
                                </div>
                              </div>
                ...
                {!userDetails.tasks?.length &&
                  ...
                  !userDetails.projects?.joined?.length && (
                    <div className="text-center py-16">
                      ...
                      <h5 className="text-xl font-bold text-gray-600 mb-2">
                        No Projects or Tasks
                      </h5>
                      <p className="text-gray-500">
                        This user hasn't been assigned any work yet
                      </p>
                    </div>
                  )}
              </div>
            ...
            <div className="p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-3 rounded-xl border border-blue-200 hover:border-blue-400 transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5">
                  <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                    <span className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-1 rounded-lg text-sm">
                      ℹ️
                    </span>
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-mono text-xs bg-blue-100 px-2 py-1 rounded">
                        {userDetails._id.substring(0, 12)}...
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 font-medium">
                      ...
                      <span className="font-semibold capitalize bg-blue-100 px-2 py-1 rounded">
                        {userDetails.role}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-3 rounded-xl border border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5">
                  <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                    <span className="bg-gradient-to-r from-green-500 to-emerald-600 text-white p-1 rounded-lg text-sm">
                      📊
                    </span>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-3 rounded-xl border border-purple-200 hover:border-purple-400 transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5">
                  <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                    <span className="bg-gradient-to-r from-purple-500 to-pink-600 text-white p-1 rounded-lg text-sm">
                      📈
                    </span>
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-blue-600 bg-blue-100 px-2 py-1 rounded shadow-sm">
                        {userDetails.tasks?.length || 0}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-green-600 bg-green-100 px-2 py-1 rounded shadow-sm">
                        {(userDetails.projects?.joined?.length || 0) +
                          (userDetails.projects?.owned?.length || 0)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-orange-600 bg-orange-100 px-2 py-1 rounded shadow-sm">
